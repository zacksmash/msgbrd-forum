		    ...
		    <div class="large-12 small-12 columns text-center hide-for-small">
			    <div class="row">
				    ...
				    <div class="large-6 small-6 columns">
				    	...
				    	<small><? if ($reply_total = $create->getUserReplyTotal($_SESSION['user_id']) == 1) : ?>Reply<? else : ?>Replies<? endif; ?></small>
				    </div>
			    </div><hr>
		    </div>
		    <div class="large-12 small-12 columns">
				...
				<ul class="button-group radius even-2" style="margin-left: 5px;">
					<li>
				 	...
				 	<li><div class="tiny secondary button" data-reveal-id="edit_discussion" style="margin-top: 20px;">Edit Discussion</div></li>
				</ul>
				<? endif; ?>
