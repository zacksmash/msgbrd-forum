	...
	<div class="large-8 small-12 columns">
		<div class="row collapse panel radius">
			...
			<div class="large-9 medium-9 small-6 right columns">
				...
				<div><a href="<?= $user['user_twitter'] ?>" target="_blank"><i class="icon-twitter"></i> Twitter</a></div>
				<? endif; ?>
				<? if ($user['user_facebook']) : ?>
				<div><a href="<?= $user['user_facebook'] ?>" target="_blank"><i class="icon-facebook"></i> Facebook</a></div>
				<? endif; ?>
				<? if ($user['user_linkedin']) : ?>
				<div><a href="<?= $user['user_linkedin'] ?>" target="_blank"><i class="icon-linkedin"></i> Linked In</a></div>
				<? endif; ?>
			</div>
			<div class="large-12 small-12 columns">
				<h6><b>About Me:</b></h6>
				<? if ($user['user_bio']) : ?><span><?= $user['user_bio'] ?></span>
			...
			<div class="large-2 small-2 columns">
				<div style="width: 50px; height: 50px; background: #efefef; border-radius: 10px; text-align: center; float: right;">
					<div style="color: #939393; position: relative; top: 5px;">
						...
						<p style="color: #aaa; font-size: 8px;">
